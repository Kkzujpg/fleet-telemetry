...
// shapes, same as web/lib/types.ts. Not imported directly from backend/src
// (each app is deployed and installed independently, see CLAUDE.md) - only
// shared/ crosses that boundary.
